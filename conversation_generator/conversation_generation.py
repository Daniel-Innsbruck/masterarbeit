...
# Logging & Output
output_file = "./data/historyAblation_systemB_turns5_maxRetries3_dialogues20_initial_question.jsonl"#"./data/45ea68d7-6e88-4ba9-a8d3-cb2366b1651a.jsonl"
log_file = "./data/historyAblation_systemB_turns5_maxRetries3_dialogues20_initial_question.log"#"./data/45ea68d7-6e88-4ba9-a8d3-cb2366b1651a.log"
    ...
    while counter < iterations:
        ...
        while turn_idx < n:
            ...
            if not cache_accepted:
                next_question = get_follow_up_question(answer, active_chunks, expanding_context=expanding_context, max_retries=MAX_RETRIES)
                #(
                #    next_question,
                #    # turn_retries
